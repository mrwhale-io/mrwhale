export const HUNGRY_ANNOUNCEMENTS: string[] = [
...
export const VERY_HUNGRY_ANNOUNCEMENTS: string[] = [
  "🐳 Ugh, hunger strikes again. Don't expect me to smile until I've had my snacks.",
...
export const STARVING_ANNOUNCEMENTS: string[] = [
