...
export const HUNGRY_ANNOUNCEMENTS: Record<string, string[]> = {
  ...
  [Mood.Okay]: [
    ...
    "🐳 If I don't get some food soon, I might just resort to eating seaweed. And trust me, nobody wants that.",
  ...
  [Mood.Grumpy]: [
    ...
    "🐳 My stomach's growling. Can't wait to deal with this inconvenience.",
    ...
    "🐳 Hunger has come to ruin my day. Someone please pass the snacks before I get even grumpier.",
